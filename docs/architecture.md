...
| SIS (Student Info System) | 🟡 | upstream `education.Student` + `Program Enrollment`; Phase **8b**: `MYS Student Transfer`, `MYS Student Leaving`, leaving certificate print format | Franchise links via custom fields; transfer/leaving workflows in flight |
